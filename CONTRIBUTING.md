...
Before you ask a question, it is best to search for existing [issues](https://github.com/conforma/crds/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

* Open an [issue](https://github.com/conforma/crds/issues/new).
